...
// Import separated backend tracking service
import { getTodayKey, fetchTrackingDataFromFirebase, saveCaloriesToFirebase, saveBmiDataToFirebase } from "../services/trackingService";
...
function Tracking() {
    ...
    useEffect(() => {
        const loadTrackingData = async (user) => {
            try {
                ...
                const { waterSnapshot, calorieSnapshot, workoutSnapshot } = await fetchTrackingDataFromFirebase(user.uid);
                ...
                const todayCalories = calorieSnapshot.docs.find(
                    (item) => item.id === today
                );
    ...
    const handleSaveCalories = async (e) => {
        ...
        try {
            ...
            await saveCaloriesToFirebase(user.uid, today, newCalories);
    ...
    const handleCalculateBMI = async (e) => {
        ...
        try {
            ...
            await saveBmiDataToFirebase(user.uid, bmiPayload);
                ...
                <section className="section">
                    <div className="container">
                        ...
                        <div className="bmi-box">
                            ...
                            >
                                <label>
                                    Height (cm) <small style={{ color: "#667085", fontWeight: "normal" }}>(e.g. 170)</small>
                                    <input
                                        id="height"
                                        type="number"
                                        min="80"
                                ...
                                <label>
                                    Weight (kg) <small style={{ color: "#667085", fontWeight: "normal" }}>(e.g. 65)</small>
                                    <input
                                        id="weight"
                                        type="number"
                                        min="20"
